...
class ProductController extends AppController{
    ...
    public function editAction(){
        ...
        $related_product = \R::getAll("SELECT related_product.related_id, product.title FROM related_product JOIN product ON product.id = related_product.related_id WHERE related_product.related_id = ?", [$id]);
        $gallery = \R::getCol("SELECT img FROM gallery WHERE product_id = ?", [$id]);
        $this->setMeta('Good editing');
