...
class Order extends AppModel {
    ...
    public static function mailOrder($order_id, $user_email){
        ...
        $message_client = (new Swift_Message("You ordered number {$order_id} on site" . App::$app->getProperty('shop_name')))
            ->setFrom([App::$app->getProperty('smtp_login') => App::$app->getProperty('shop_name')])
            ->setTo($user_email)
            ->setBody($body, 'text/html');
        ;

        $message_admin = (new Swift_Message("Order number {$order_id}"))
            ->setFrom([App::$app->getProperty('smtp_login') => App::$app->getProperty('shop_name')])
        ...
        $_SESSION['success'] = 'Thank you for your offer';
    }
