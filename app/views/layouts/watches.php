			...
			<div class="top-header-main">
				<div class="col-md-6 top-header-left">
					<div class="drop">
                        ...
                        <div class="btn-group">
                            <a class="dropdown-toggle" data-toggle="dropdown">Acoount <span class="caret"></span></a>
                        ...
                        <a href="cart/show" onclick="getCart(); return false;">
                            <div class="total">
                                ...
                                <?php if(!empty($_SESSION['cart'])): ?>
                                    <span class="simpleCart_total"><?=$_SESSION['cart.currency']['symbol_left'] . $_SESSION['cart.sum'] . $_SESSION['cart.currency']['symbol_left'];?></span>
                                    <?php else: ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="cart/view" type="button" class="btn btn-primary">Offer</a>
